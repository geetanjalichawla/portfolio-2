    ...
    <Box>
      <Flex
        ...
        <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
          ...
          <Flex display={{ base: 'none', md: 'flex' }} justifyContent={'center'} alignItems={'center'} w={'full'} ml={10}>
            <DesktopNav />
          </Flex>
        </Flex>
        ...
        <Stack
          ...
          justify={'flex-end'}
          direction={'row'}>
          <Button size={'sm'} fontWeight={'medium'} px={'1'} variant={'ghost'} _hover={{background:"none"}}>
            En
          </Button>
            <ModeToggle/>
        </Stack>
...
const DesktopNav = () => {
  ...
  return (
    <Stack direction={'row'} spacing={4} w={'full'} justifyContent={'center'} align={'center'} >
